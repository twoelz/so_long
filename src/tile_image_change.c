...
/*   Updated: 2025/05/27 09:40:52 by tda-roch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	g->tile.player_left->instances[0].y -= TILE;
	g->tile.player_right->instances[0].y -= TILE;
	g->tile.player_up_right->instances[0].y -= TILE;
	g->tile.player_up_left->instances[0].y -= TILE;
	g->tile.player_down_right->instances[0].y -= TILE;
	g->tile.player_down_left->instances[0].y -= TILE;
...
{
	g->tile.player_left->instances[0].x -= TILE;
	g->tile.player_right->instances[0].x -= TILE;
	g->tile.player_up_right->instances[0].x -= TILE;
	g->tile.player_up_left->instances[0].x -= TILE;
	g->tile.player_down_right->instances[0].x -= TILE;
	g->tile.player_down_left->instances[0].x -= TILE;
	disable_player_images(g);
	g->looking_left = true;
