...
/*   Updated: 2025/05/19 12:25:40 by tda-roch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	return_error(t_game_data *g)
{
	...
	ft_putstr_fd(g->error_messages[g->error_code].message, STDOUT_FILENO);
	// if (error_code == MAP_NO_PATH_ARGUMENT)
	// 	ft_putstr_fd(E_NO_PATH_ARGUMENT_MSG, STDOUT_FILENO);
