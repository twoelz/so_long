...
/*   Updated: 2025/06/09 00:46:37 by tda-roch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_game_images(t_game_data *g)
{
	...
	png_to_tile(g, &g->tile.space, TILE_SPACE);
	png_to_tile(g, &g->tile.exit_closed, TILE_EXIT_CLOSED);
	png_to_tile(g, &g->tile.exit_open, TILE_EXIT_OPEN);
	png_to_tile(g, &g->tile.wall, TILE_WALL);
	png_to_tile(g, &g->tile.player_right, TILE_PLAYER_RIGHT);
	png_to_tile(g, &g->tile.player_left, TILE_PLAYER_LEFT);
	png_to_tile(g, &g->tile.player_up_right, TILE_PLAYER_UP_RIGHT);
	png_to_tile(g, &g->tile.player_up_left, TILE_PLAYER_UP_LEFT);
	png_to_tile(g, &g->tile.player_down_right, TILE_PLAYER_DOWN_RIGHT);
	png_to_tile(g, &g->tile.player_down_left, TILE_PLAYER_DOWN_LEFT);
	i = 0;
